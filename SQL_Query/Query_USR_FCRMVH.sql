...
SELECT TOP 6000 FCRMVH_VNDDOR, FCRMVH_USERID, USR_UBFSEC_DESCRP, FCRMVH_DEPSAL, FCRMVH_DEPOSI, * FROM [dbo].[USR_FCRMVH] 
WHERE FCRMVH_NROGUI = 'T002-4421' or FCRMVH_NROGUI = 'T002-4442'
...
SELECT JURISDICCION, * FROM [dbo].GUIAS_REMISION 
--WHERE NUMERO_GUIA = 'T003-40328'  --37725
...
--	SET UBICACION_SECTOR = i.USR_UBFSEC_DESCRP
--FROM [USR_FCRMVH] as i
