...
WHERE FCRMVH_NROGUI = 'T001-63584' --or FCRMVH_NROGUI = 'T003-43282'
...
WHERE NUMERO_GUIA = 'T001-63584'  --37725
...
--	SET CODIGO_TRANSFERENCIA = i.FCRMVH_DEPSAL,
...
--	SET STATUS_PICKING = 'Picking Retirado',
--	CONTINGENCIA = 1
--WHERE STATUS_PICKING = 'Picking Terminado' and
--	id < 55982
--FROM [USR_FCRMVH] as i
...
WHERE NUMERO_GUIA = 'T001-48111'  --57636
--GUIA_ID = 57636
ORDER BY id desc
