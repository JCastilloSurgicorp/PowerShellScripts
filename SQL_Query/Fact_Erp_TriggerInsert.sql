    ...
    BEGIN TRY
		INSERT INTO [dbo].[FACT_DETALLE]
			...
			SELECT i.VTRMVH_NRODOC, i.VTRMVH_FECALT, i.VTRMVH_IMPORT, i.VTRMVH_DESCOF, i.VTRMVH_NOMCLI, i.VTRMVH_DESCND,
				...
				ISNULL(i.VTRMVH_NCRFAC, '-'), i.VTRMVH_TITGRA, CAST(i.VTRMVH_CODEMP as BIGINT), i.VTRMVH_DIRECC, ISNULL(i.VTRMVH_DESSED, '-'), 
				i.VTRMVH_NROAPP, i.VTRMVH_OCCLIE, ISNULL(i.VTRMVH_TIPCLI, '-'), i.VTRMVH_USERID, i.VTRMVH_DESZON, i.VTRMVH_CORDET, i.VTRMVH_CORRET, 
				i.VTRMVH_IMPNAC, 'Creado por Servidor'
			FROM inserted AS i
	END TRY
	BEGIN CATCH
